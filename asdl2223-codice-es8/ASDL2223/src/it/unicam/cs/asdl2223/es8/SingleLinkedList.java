...
public class SingleLinkedList<E> implements List<E> {
    ...
    public boolean contains(Object o) {
        ...
        Iterator<E> thisIterator = this.iterator();
        while (thisIterator.hasNext()) if (o.equals(thisIterator.next())) return true;
        return false;
    }
    ...
    public boolean add(E e) {
        ...
        if (!(e instanceof E)) throw new ClassCastException();
    ...
    public E set(int index, E element) {
        ...
        if (!(element instanceof E)) throw new ClassCastException();
        if (index >= this.size || index < 0) throw new IndexOutOfBoundsException();

        E selected = null;

        if (index == 0) {
            selected = this.head.item;
            ...
            while (!(current.next == null)) {
                if (index == contPosition) {
                    selected = current.item;
                    current.item = element;
                    this.numeroModifiche++;
                    E nuovo = current.item;
                    return selected;
                }
                current = current.next;
                contPosition++;
    ...
    public void add(int index, E element) {
        ...
        if (index == 0) {
            Node<E> former = this.head;
            this.head = new Node<>(element, former);
            this.size++;
            this.numeroModifiche++;
        } else {
            Node<E> previous = this.head;
            ...
            //fino a current diverso da tail
