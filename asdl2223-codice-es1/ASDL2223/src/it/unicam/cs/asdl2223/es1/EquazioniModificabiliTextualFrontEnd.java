...
public class EquazioniModificabiliTextualFrontEnd {
    ...
    public static void main(String[] args) {
        ...
        while (!terminate) {
            ...
            /**
             * La modifica è la stessa in tutti e tre i cicli do/while:
             * il problema era che il ciclo non resettava mai a false il
             * valore di retry per cui anche una volta reinserito il parametro
             * correttamente, il programma continua a rieseguire il ciclo.
             */

            do {
                retry = false; /* Modifica */
                System.out.println(
