...
class PrenotazioneTest {
    ...
    final void testHashCode() {
        ...
        Prenotazione p2 = new Prenotazione("B1", ts2, "", "");
        assertEquals(p1, p2);
        assertEquals(p2, p1);
    ...
    final void testPrenotazione() {
        ...
        assertThrows(NullPointerException.class, () -> new Prenotazione("B1",
    ...
    final void testEqualsObject() {
        ...
        Prenotazione p4 = new Prenotazione("Pluto", ts1, " ", "");
        assertNotEquals(p1, p4);
        assertNotEquals(p4, p1);
        // Classe diversa
        assertNotEquals("Pippo", p1);
        // Null
