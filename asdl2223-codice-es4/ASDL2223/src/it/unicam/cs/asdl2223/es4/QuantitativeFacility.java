...
public class QuantitativeFacility extends Facility {
    ...
    public boolean satisfies(Facility o) {
        if (o == null) {
            throw new NullPointerException("Hai passato un oggetto nullo.");
        }
        return ((o instanceof QuantitativeFacility) && (o.getCodice().equals(this.getCodice()))
                && (this.getQuantity() >= ((QuantitativeFacility) o).getQuantity()));
    }
